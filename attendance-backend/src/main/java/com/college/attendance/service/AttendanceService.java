...
public class AttendanceService {
        ...
        public List<AttendanceUserResponse> getAttendanceUsers(
                ...
                List<AttendanceUserResponse> result = new ArrayList<>();
                ...
                if (type == null
                        ...
                        List<Student> students = studentRepository.searchAttendanceStudents(
                                        search,
                                        courseId,
                                        semesterId,
                                        sectionId,
                ...
                if (type == null
                        ...
                        List<Teacher> teachers = teacherRepository.searchAttendanceTeachers(
                                        search,
                                        departmentId);
        ...
        public AttendanceMarkResponse checkOut(
                ...
                log.info(
                                "Mobile Check-Out Request: latitude={}, longitude={}, fileName={}, fileSize={}",
                                latitude,
                                longitude,
                ...
                log.info(
                                "Mobile Check-Out User: userId={}, username={}",
                                user.getId(),
                                user.getUsername());
        ...
        private FaceVerificationResult verifyFace(
                ...
                if (registeredEmbedding == null
                        ...
                        log.error(
                                        "Invalid embedding size for userId={}, size={}",
                                        userId,
                ...
                try {
                        ...
                        result = faceRecognitionClient.verifyAttendance(
                                        registeredEmbedding,
                                        file);
                        ...
                        log.error(
                                        "Face attendance verification failed for userId={}",
                                        userId,
                                        e);
                ...
                boolean verified = getBoolean(
                                result,
                                "verified");

                boolean spoof = getBoolean(
                                result,
                                "spoof");

                boolean faceDetected = getBoolean(
                                result,
                                "faceDetected");

                int faceCount = getInteger(
                                result,
                                "faceCount");
                ...
                double threshold = getDouble(
                                result,
                                "threshold");

                double antiSpoofScore = getDouble(
                                result,
                                "antiSpoofScore");
                ...
                log.info(
                                "Face attendance verification: " +
                                                ...
                                                "faceDetected={}, faceCount={}, distance={}, " +
                                                "threshold={}, antiSpoofScore={}, model={}, message={}",
                                userId,
                                success,
                                verified,
                                spoof,
        ...
        private Double calculateConfidence(
                ...
                double cosineSimilarity = 1.0 - distance;

                double confidence = cosineSimilarity * 100.0;

                confidence = Math.max(
                                0.0,
                                Math.min(100.0, confidence));

                log.info(
                                "[CONFIDENCE] distance={}, similarity={}, confidence={}%",
                                distance,
                                cosineSimilarity,
                                confidence);
